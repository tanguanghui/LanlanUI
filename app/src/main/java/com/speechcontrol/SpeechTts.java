...
public class SpeechTts extends Activity implements View.OnClickListener {
    private static String TAG = SpeechTts.class.getSimpleName();
    // 语音合成对象
...
//    private String[] localVoicersValue ;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_speechtts);
        initLayout();
...
//                        //启动本地引擎
//					String path = ResourceUtil.TTS_RES_PATH+"="+ ResourceLoader.getResPath(SpeechTts.this,mSharedPreferences,"tts")+","+ResourceUtil.ENGINE_START+"=tts";
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()) {
            case R.id.image_tts_set:
                Intent intent = new Intent(SpeechTts.this, TtsSettings.class);
