...
//        fragmentManager = getFragmentManager();
    ...
    public void initView() {
        ...
        //侧滑菜单控件
        dl = (DragLayout) mActivity.findViewById(R.id.drag_layout);
     ...
     *
     * @param position 每个tab页对应的下标。0表示主页，1表示地图，2表示设置。
     */
        ...
        switch (position) {
            ...
            case 1:
                ...
                if (addressFragment == null) {
                    ...
                    transaction.add(R.id.frame_content, addressFragment);
                } else {
            ...
            case 2:
                ...
                if (settingFragment == null) {
                    ...
                    transaction.add(R.id.frame_content, settingFragment);
                } else {
