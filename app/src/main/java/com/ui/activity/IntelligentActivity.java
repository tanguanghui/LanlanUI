                        ...
                        public void run() {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    intelligentAdapter = new IntelligentAdapter(myArrayList,IntelligentActivity.this, new OnItemOnclickCallback() {

                                        @Override
                                        public void OnItemClick(View view, int postion) {
                                            Intent intent=new Intent(IntelligentActivity.this,MessageReplyActivity.class);
                                            intent.putExtra("message",new Gson().toJson(myArrayList.get(postion)));
