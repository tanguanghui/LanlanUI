...
public class Urlutils {
    //通信地址
    private static String IP ="192.168.1.194";
//    private static String webUrl = "192.168.108.100";
    private static String webUrl = IP;
...
//    static String deadUrl = "http://192.168.108.100:8888/temp/qrcode.jpg";
    static String codeUrl = "http://"+IP+":8888/temp/wxqr.png";
    static String deadUrl = "http://"+IP+":8888/temp/qrcode.jpg";
...
//    static String txtUrl = "http://192.168.108.100:8888/a.txt";
    static String txtUrl = "http://"+IP+":8888/a.txt";
...
//    static String intelligentTextUrl = HOST + "weifen/selectIntelligent.php";
    static String intelligentTextUrl = HOST + "VicmobLazyEarn/lazyearn-api/vicCodeText/selectIntelligent";
    //删除文本回复内容
