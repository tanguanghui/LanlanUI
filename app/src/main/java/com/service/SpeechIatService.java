...
import com.speechcontrol.speech.setting.IatSettings;
...
/**
 * Created by smartOrange_4 on 2017/11/1.
 */

public class SpeechIatService extends Service {
    @Nullable
    @Override
...
//        mResultText = ((EditText)findViewById(R.id.iat_text));
    ...
    private void initIat(){
        ...
        mIat = SpeechRecognizer.createRecognizer(SpeechIatService.this, mInitListener);
        ...
        if (ret != ErrorCode.SUCCESS) {
            ...
            mToast.setText(getString(R.string.text_begin));
            mToast.show();
        }
